...
public class InnerForestChunkGen extends ChunkGen{
	public InnerForestChunkGen(World world, int chunkX, int chunkZ, BiomeGrid biomeGrid) {
		super("Inner Forest", ChunkType.FOREST, false, 1, chunkX, chunkZ, world, biomeGrid);
	}

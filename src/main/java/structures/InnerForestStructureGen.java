...
public class InnerForestStructureGen extends StructureGen {

	public InnerForestStructureGen(World world) {
	...
	public void populate(Chunk chunk) {
		...
		for (int i = 1; i < amount; i++) {
			...
			fillChunkRegion_p(X, Y, Z, X, Y + bonusHeight - 2, Z, Material.OAK_LOG, chunk);
			...
			setChunkBlock_p(X, Y + bonusHeight - 1, Z, Material.OAK_LOG, chunk);
		}
	}
}
